...
## 2025-01-20 - Framer Motion Scroll Performance
**Learning:** Avoid passing continuous animations (like scroll progress from `useScroll`) to React state (via `useState`), as this causes the component to re-render on every frame.
