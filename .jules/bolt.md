...
## 2024-11-20 - Refactor Animations
...
**Action:** Use `useSpring` and `useTransform` with Framer Motion primitives rather than React state when animating continuous numerical values.
