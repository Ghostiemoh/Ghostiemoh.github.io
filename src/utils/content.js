...
export const CONTENT_MATRIX = {
  [MODES.ON_CHAIN]: {
    ...
    projects: [
      { id: "ST-01", title: "Superteam Earn Wins", category: "Proof of Work", description: "7 Competitive Bounty Wins in technical research and on-chain analysis.", tags: ["Superteam", "Wins"], icon: 'Award', link: 'https://superteam.fun/earn/t/Ghostiemoh' },
