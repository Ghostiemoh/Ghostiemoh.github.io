  ...
  return (
    <div className="fixed bottom-12 left-1/2 -translate-x-1/2 z-[100] px-4 w-full max-w-xl">
      <div className="relative group">
        ...
        <nav aria-label="Operational Mode Selection" className="relative flex items-center justify-between p-2 rounded-[2rem] bg-black/40 backdrop-blur-3xl border border-white/10 shadow-2xl overflow-hidden">
          {modes.map((mode) => {
