              ...
              >
                <div className={`relative flex flex-col items-center gap-1.5 py-4 px-2 rounded-2xl transition-all duration-500 ${
                  ...
                  <div className="relative flex flex-col items-center">
                    ...
                    <span className={`text-[7px] font-bold tracking-[0.3em] opacity-0 group-hover/btn:opacity-30 focus-within/btn:opacity-30 transition-opacity mt-1 ${isActive ? 'text-secondary opacity-40' : ''}`}>
                      {mode.sector}
                    </span>
                  </div>
