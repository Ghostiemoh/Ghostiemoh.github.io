          ...
          {modes.map((mode) => {
            ...
            return (
              <button
                ...
                className="relative flex-1 group/btn focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary/50 rounded-2xl"
              >
                <div className={`relative flex flex-col items-center gap-1.5 py-4 px-2 rounded-2xl transition-all duration-500 ${
                  isActive ? 'text-white' : 'text-white/20 hover:text-white/40 group-focus-visible/btn:text-white/40'
                }`}>
