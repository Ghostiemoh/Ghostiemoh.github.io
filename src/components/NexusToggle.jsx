          ...
          {modes.map((mode) => {
            ...
            return (
              <button
                ...
                className="relative flex-1 group/btn focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-secondary focus-visible:rounded-2xl focus-visible:z-10"
              >
