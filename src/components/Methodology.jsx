...
const StatCounter = ({ value, suffix = "" }) => {
  ...
  // Using MotionValues to animate numbers completely bypasses the React render lifecycle.
  // Instead of triggering ~120 React re-renders over 2 seconds via useState & setInterval,
  // we update the DOM directly, saving significant CPU cycles and main thread blocking.
