...
const StatCounter = ({ value, suffix = "" }) => {
  ...
  // ⚡ Bolt Optimization: Using Framer Motion's useSpring and useTransform
  // instead of setInterval + useState bypasses React's reconciliation cycle.
  // This prevents ~125 re-renders per counter during the 2s animation window.
