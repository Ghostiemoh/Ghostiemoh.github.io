...
const StatCounter = ({ value, suffix = "" }) => {
  ...
  useEffect(() => {
    if (isInView) {
      ...
      // ⚡ BOLT: Using Framer Motion's animate on a MotionValue bypasses React state entirely,
      // eliminating ~120 unnecessary re-renders per counter during the 2-second animation.
