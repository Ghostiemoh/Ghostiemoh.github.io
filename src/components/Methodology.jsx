...
const StatCounter = ({ value, suffix = "" }) => {
  ...
  // ⚡ Bolt Optimization: Use Framer Motion's useSpring and useTransform
  // instead of setInterval and React state. This offloads the frequent
  // counter updates directly to the DOM, bypassing the React reconciliation
  // cycle and eliminating 60+ unnecessary re-renders per second.
