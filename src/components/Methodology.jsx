...
// ⚡ BOLT OPTIMIZATION:
// Replaced state-driven setInterval (which caused ~60 React re-renders per second)
// with Framer Motion's useMotionValue. By passing a MotionValue as the single direct
// child of <motion.span>, we completely bypass the React render cycle during animation.
