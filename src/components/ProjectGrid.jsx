...
/* Bolt Optimization: Extracted static array and derived categories outside the component to prevent unnecessary memory allocation and Set computation on every render. */
const caseFiles = [
  {
    id: "SD-01",
