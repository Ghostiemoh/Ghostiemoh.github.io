...
// Bolt Optimization: Extracted static array outside render loop to prevent re-allocation
const caseFiles = [
    {
      id: "SD-01",
...
const ProjectGrid = () => {
  ...
  // Bolt Optimization: Memoize derived state to prevent recalculation on every render
