...
// ⚡ Bolt Optimization: Extracted static `caseFiles` and `categories` arrays
...
const ProjectGrid = () => {
  ...
  // ⚡ Bolt Optimization: Memoized the filtering operation so it only recalculates
  // when `selectedCategory` changes, reducing CPU load on unrelated state changes.
