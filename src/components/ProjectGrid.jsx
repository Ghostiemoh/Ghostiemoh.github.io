...
// ⚡ Bolt: Moved static data and expensive initialization outside the render loop
// to prevent O(N) reallocation and recalculation on every render.
const caseFiles = [
  {
    id: "SD-01",
...
const ProjectGrid = () => {
  ...
  // ⚡ Bolt: Memoized derived state to prevent filtering array on unassociated renders
