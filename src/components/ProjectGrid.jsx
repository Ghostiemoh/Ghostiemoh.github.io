...
// ⚡ Bolt: Extracted static caseFiles and categories array outside component to prevent unnecessary memory allocations on every render.
const caseFiles = [
  {
    id: "SD-01",
...
const ProjectGrid = () => {
  ...
  // ⚡ Bolt: Memoize filteredProjects to prevent unnecessary filtering on re-renders unless selectedCategory changes.
