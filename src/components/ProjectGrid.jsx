 ...
 * Extracted static array and categories computation outside component scope
 * to prevent memory allocations, garbage collection, and O(n) Set calculations on every render.
 */
const caseFiles = [
    {
      id: "SD-01",
