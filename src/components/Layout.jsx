...
const Layout = ({ children }) => {
  ...
  // ⚡ Bolt: Optimized scroll progress to prevent continuous React re-renders.
  // We map the continuous scrollYProgress to a formatted string using useTransform,
  // completely bypassing the React render cycle on every scroll frame.
