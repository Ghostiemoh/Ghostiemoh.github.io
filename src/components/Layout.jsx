...
const Layout = ({ children }) => {
  ...
  // Optimize scroll tracking by avoiding React state updates.
  // We use useTransform to map scrollYProgress to a formatted string.
  // Framer Motion 11+ allows passing MotionValues directly as children.
