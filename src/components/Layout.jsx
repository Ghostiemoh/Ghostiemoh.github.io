...
const Layout = ({ children }) => {
  ...
  // We use `useTransform` to convert the continuous scroll value directly into a formatted string
  // (e.g. "45%"). By passing this MotionValue directly as a child to a <motion.span>, we completely
  // bypass React component re-renders during scrolling, keeping the main thread free.
