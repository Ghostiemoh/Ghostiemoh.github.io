...
const Layout = ({ children }) => {
  ...
  // Bolt Optimization: Replaced useEffect + useState with Framer Motion's useTransform
  // to bypass expensive React re-renders on every scroll tick.
  const displayPercent = useTransform(scrollYProgress, (latest) => `${Math.round(latest * 100)}%`);
