...
const Layout = ({ children }) => {
  ...
  /* ⚡ Bolt: Removed `useState` and `useEffect` for continuous scroll to prevent Layout component from re-rendering on every frame. Instead, mapping MotionValue directly. */
