...
const Layout = ({ children }) => {
  ...
  // ⚡ Bolt: Use Framer Motion's useTransform to map scroll value directly to a formatted string.
  // This bypasses continuous React re-renders caused by state updates on scroll.
