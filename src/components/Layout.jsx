...
const ProgressHUD = ({ scaleY, displayPercent }) => (
...
const Header = ({ isScrolled, theme, toggleTheme, mobileMenuOpen, setMobileMenuOpen }) => (
  <header className={cn(
...
const MobileMenu = ({ mobileMenuOpen, setMobileMenuOpen, theme, toggleTheme }) => (
  <AnimatePresence>
    {mobileMenuOpen && (
      <motion.div
        id="mobile-menu"
...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-surface selection:bg-secondary/30 selection:text-on-surface">
      <ProgressHUD scaleY={scaleY} displayPercent={displayPercent} />
      <Header
