...
const Layout = ({ children }) => {
  ...
  // Replaced React state (useState + onChange) with useTransform for scroll progress.
  // This bypasses the React render cycle, preventing the Layout component and its children
  // from re-rendering on every single scroll frame.
