...
const Layout = ({ children }) => {
  ...
  // Replaced useState with useTransform to calculate scroll percentage.
  // This allows <motion.span> to directly update the DOM without triggering a re-render of the Layout component.
