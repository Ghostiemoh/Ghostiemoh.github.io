...
const Layout = ({ children }) => {
  ...
  // ⚡ BOLT OPTIMIZATION: Bypass React re-renders by using useTransform instead of useState/useEffect
  // and passing the MotionValue as a direct child to motion.span.
