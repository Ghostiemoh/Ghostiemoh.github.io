...
const Layout = ({ children }) => {
  ...
  // ⚡ Bolt: Use useTransform to derive text directly from MotionValue.
  // This bypasses React state updates on every scroll frame, eliminating
  // unnecessary re-renders of the Layout component and improving scroll performance.
