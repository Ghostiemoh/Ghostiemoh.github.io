...
const Layout = ({ children }) => {
  ...
  // Optimization: useTransform creates a MotionValue that can be passed directly as a child to motion elements.
  // This bypasses React's render phase entirely, preventing full layout re-renders on scroll.
