...
const Layout = ({ children }) => {
  ...
  // ⚡ Bolt Optimization: Use useTransform to create a MotionValue for the display string.
  // This avoids triggering React re-renders on the Layout component during every scroll event,
  // bypassing the render cycle for continuous values.
