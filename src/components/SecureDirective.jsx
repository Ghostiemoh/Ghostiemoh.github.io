              ...
              <div className="relative p-12 rounded-[3rem] bg-white/[0.02] border border-white/10 backdrop-blur-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      <label htmlFor="auth-email" className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40 ml-4">Return Frequency</label>
                      <input 
                        id="auth-email"
                        type="email" 
                        required
                  ...
                  <div className="space-y-2">
                    <label htmlFor="auth-mission" className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40 ml-4">The Mission</label>
                    <textarea 
                      id="auth-mission"
                      required
