              ...
              <div className="relative p-12 rounded-[3rem] bg-on-surface/[0.02] border border-on-surface/10 backdrop-blur-xl transition-[border-color,background-color] duration-200 ease-out">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="name" className="text-[9px] font-black uppercase tracking-[0.3em] text-on-surface/40 ml-4 transition-colors duration-700">Authorized Name</label>
                      <input 
                        id="name"
                        type="text" 
                        required
                    ...
                    <div className="space-y-2">
                      <label htmlFor="email" className="text-[9px] font-black uppercase tracking-[0.3em] text-on-surface/40 ml-4 transition-colors duration-200 ease-out">Return Frequency</label>
                      <input 
                        id="email"
                        type="email" 
                        required
                  ...
                  <div className="space-y-2">
                    <label htmlFor="message" className="text-[9px] font-black uppercase tracking-[0.3em] text-on-surface/40 ml-4 transition-colors duration-700">The Mission</label>
                    <textarea 
                      id="message"
                      required
