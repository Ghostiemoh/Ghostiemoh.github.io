      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
              ...
              <div className="relative p-12 rounded-[3rem] bg-white/[0.02] border border-white/10 backdrop-blur-xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label htmlFor="auth-name" className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40 ml-4">Authorized Name</label>
                      <input 
                        id="auth-name"
                        type="text" 
                        required
                    ...
                    <div className="space-y-2">
                      <label htmlFor="return-freq" className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40 ml-4">Return Frequency</label>
                      <input 
                        id="return-freq"
                        type="email" 
                        required
                  ...
                  <div className="space-y-2">
                    <label htmlFor="mission-desc" className="text-[9px] font-black uppercase tracking-[0.3em] text-white/40 ml-4">The Mission</label>
                    <textarea 
                      id="mission-desc"
                      required
        ...
        <div className="mt-40 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 opacity-40">
           ...
           <div className="flex gap-8">
              <a href="https://github.com/Ghostiemoh" target="_blank" rel="noopener noreferrer" aria-label="Visit Ghostiemoh GitHub Profile" title="Visit Ghostiemoh GitHub Profile" className="hover:text-secondary transition-colors">
                <Github size={16} />
              </a>
           </div>
        </div>
