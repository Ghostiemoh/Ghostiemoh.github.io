      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="mt-40 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 opacity-40">
           ...
           <div className="flex gap-8">
              <a href="https://github.com/Ghostiemoh" target="_blank" rel="noopener noreferrer" aria-label="View on GitHub" title="View on GitHub" className="hover:text-secondary transition-colors">
                <Github size={16} />
              </a>
           </div>
        </div>
