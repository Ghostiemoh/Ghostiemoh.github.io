          ...
          >
              {credentials.map((cred, i) => (
                ...
                >
                   ...
                   <div className="mt-auto pt-6 border-t border-on-surface/5 flex justify-between items-center text-[9px] font-black uppercase tracking-widest opacity-30 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
