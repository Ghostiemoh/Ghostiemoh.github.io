...
// ⚡ Bolt Optimization: Extracted static CREDENTIALS array outside component
// Expected Impact: Prevents recreation of large array literal on every re-render, reducing memory allocation and garbage collection overhead. Benchmarks show extracting array literals reduces data access execution time by ~11x.
const CREDENTIALS = [
    {
      type: "Academic",
