...
import { Award, GraduationCap, FileText, ChevronRight, CheckCircle2 } from 'lucide-react';
...
const IntelHub = () => {
  const credentials = [
    ...
    {
      type: "Certification",
      title: "Web3/Solana Bootcamp",
      org: "Unboxed Software",
      status: "Blockchain Native",
      icon: <Award size={20} />
    },
    {
      type: "Certification",
    ...
    },
    {
      ...
      org: "Metana",
      status: "Advanced Protocol Analysis",
          ...
          <div className="lg:col-span-5 space-y-10">
            ...
            <div className="p-10 rounded-[2.5rem] bg-on-surface/5 border border-on-surface/5 space-y-6">
               ...
               <div className="flex flex-wrap gap-3">
                  {["Python", "SQL", "Excel", "Tableau", "Power BI", "Blockchain Forensics", "Cryptography"].map(skill => (
          ...
          <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
             {credentials.map((cred, i) => (
               <motion.div 
                  ...
                  className="card-low bg-surface border border-on-surface/5 rounded-[2.5rem] p-8 flex flex-col gap-6 group hover:border-secondary transition-all duration-700"
               >
