                    ...
                    <div className="flex justify-between items-start">
                       ...
                       <div className="flex flex-col items-end gap-2">
                          ...
                          <div className="flex gap-2 transition-all duration-500">
                             {project.view && (
                               <button onClick={() => setViewerFile(project)} title="Click to view" aria-label="Click to view project" className="p-3 bg-secondary/10 border border-secondary/20 rounded-xl text-secondary hover:bg-secondary hover:text-white transition-all cursor-pointer">
                                  <Eye size={16} />
                               </button>
                             )}
                             {project.link && (
                               <a href={project.link} target="_blank" rel="noopener noreferrer" title="Open project" aria-label="Open project" className="p-3 bg-secondary/10 border border-secondary/20 rounded-xl text-secondary hover:bg-secondary hover:text-white transition-all">
