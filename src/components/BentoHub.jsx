                    ...
                    <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity duration-200 ease-out">
                      {project.view && (
                        <button
                          ...
                          className="p-2.5 bg-surface/90 backdrop-blur-sm border border-on-surface/10 rounded-xl text-secondary hover:bg-secondary hover:text-white focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-surface active:scale-[0.95] transition-[transform,background-color,color] duration-100 ease-out cursor-pointer"
                        >
                          <Eye size={14} />
                        </button>
                      )}
                      {project.link && (
                        <a
                          ...
                          className="p-2.5 bg-surface/90 backdrop-blur-sm border border-on-surface/10 rounded-xl text-secondary hover:bg-secondary hover:text-white focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-surface active:scale-[0.95] transition-[transform,background-color,color] duration-100 ease-out"
                        >
                      ...
                      {project.download && (
                        <a
                          ...
                          className="p-2.5 bg-surface/90 backdrop-blur-sm border border-on-surface/10 rounded-xl text-on-surface/60 hover:bg-on-surface hover:text-surface focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-secondary focus-visible:ring-offset-2 focus-visible:ring-offset-surface active:scale-[0.95] transition-[transform,background-color,color] duration-100 ease-out"
                        >
                          <Download size={14} />
                        </a>
                      )}
